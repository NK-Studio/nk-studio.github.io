...
const projectDetailsData = {
  ...
  tavuti: {
    ...
    overview: "청강문화산업대학교 졸업작품팀 'Ipari'의 3D 액션 프로젝트 타부티(TAVUTI)에 테크니컬 아티스트 서포터로 참여하여, 캐릭터 및 환경 오브젝트의 물리적 텐션 시뮬레이션을 정밀 세팅하고 그래픽 완성도를 높이는 핵심 연출 셰이딩 구현 및 개발팀 전반의 프로그래밍 이슈를 자문한 프로젝트입니다.",
    details: [
